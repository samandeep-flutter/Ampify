...
sealed class ImageRes {
  ...
  static final String musicAdd = _toIcons('music-add.png');
  static final String editMusic = _toIcons('edit-music.png');
  static final String sort = _toIcons('sort.png');
  static final String copyrightC = _toIcons('copyright.png');
  static final String copyrightP = _toIcons('copyright-p.png');
